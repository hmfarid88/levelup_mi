...
<html>
    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        try {
            ...
            String query10 = "select sum(AMOUNT) from customer_pay where PAY_TYPE='Bank' and DATE=CURDATE()";
            ...
            String dbt1="select RETAILER, AMOUNT from customer_pay where PAY_TYPE='Cash' and DATE=CURDATE()";
            ...
            String crd1="select COMPANY_NAME, AMOUNT from company_payment where DATE=CURDATE()";
            ...
            String dbt3="select RETAILER, AMOUNT from customer_pay where PAY_TYPE='Bank' and DATE=CURDATE()";
            ps = con.prepareStatement(dbt3);
            rs18 = ps.executeQuery();
            ...
            rs19 = ps.executeQuery();
                               ...
                               while (rs10.next()) {
                                ...
                                %>
                                <tr>   
                                    <td style="text-align: center"><%=rs10.getString(1) %></td> 
                               ...
                               while (rs11.next()) {
                                ...
                                %>
                                <tr>   
                                    <td style="text-align: center"><%=rs11.getString(1) %></td> 
                               ...
                               while (rs18.next()) {
                                ...
                                %>
                                <tr>   
                                    <td style="text-align: center"><%=rs18.getString(1) %> by Bank</td> 
                                    <td style="text-align: center"><%= rs18.getLong(2) %></td> 
                                    <td></td> 
                                </tr>
                                <%  }
                                   while (rs13.next()) {
                                %>
                                <tr>
                                    <td style="text-align: center"><%=rs13.getString(1) %></td> 
                                    <td></td>
                                ...
                                %>
                                <tr>
                                    <td style="text-align: center"><%=rs14.getString(1) %></td> 
                                    <td></td>
...
try { if (rs18 != null) rs18.close(); } catch (SQLException ex2) { }
