...
<html>
    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        <%
            ...
            rs1 = ps.executeQuery();
            String dbt1="select RETAILER, AMOUNT, DATE from customer_pay where PAY_TYPE='Cash' and DATE='" + date1 + "'";
            ps = con.prepareStatement(dbt1);
            rss1 = ps.executeQuery();
            String dbt11="select RETAILER, AMOUNT, DATE from customer_pay where PAY_TYPE='Bank' and DATE='" + date1 + "'";
            ps = con.prepareStatement(dbt11);
            rss11 = ps.executeQuery();
            ...
            rs2 = ps.executeQuery();
            String crd1="select COMPANY_NAME, AMOUNT, DATE from company_payment where  DATE='" + date1 + "'";
            ...
            rsssss2 = ps.executeQuery();
                ...
                String query33 = "select sum(AMOUNT) from customer_pay where PAY_TYPE='Bank' and  DATE= '" + date1 + "' ";
                ps = con.prepareStatement(query33);
                rs33 = ps.executeQuery();
                rs33.next();
                request.setAttribute("tcbpay", rs33.getLong(1));
         ...
         Long totalpayment=rs5.getLong(1)+rs6.getLong(1)+rs7.getLong(1)+rs9.getLong(1)+rs11.getLong(1)+rs33.getLong(1);
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div id="div_print" style="background-color: #030303; color: #ffffff">
                    <center>
                        <h3 style="font-family: fontawaesome" class="text-primary text-center"><b>Cash-Book (MI)</b></h3>
                            ...
                            <tbody>
                               ...
                               while (rss1.next()) {
                                ...
                                <tr>   
                                    ...
                                    <td style="text-align: center"><%=rss1.getString(1) %></td> 
                               ...
                               while (rss11.next()) {
                                ...
                                %>
                                <tr>   
                                    <td style="text-align: center"><%=rss11.getString("DATE") %></td> 
                                    <td style="text-align: center"><%=rss11.getString(1) %> by Bank</td> 
                                    <td style="text-align: center"><%= rss11.getLong(2) %></td> 
                                    <td></td> 
                                </tr>
                                <%
                                   }
                               while (rsss1.next()) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center"><%=rss2.getString(1) %></td> 
                                    <td></td>
...
%>
                                <tr style="border-bottom-color: black">
                                    ...
                                    <th style="text-align: center;border-left-style: hidden;border-right-style: hidden"><u>${tcredit+tpay+tcost+empcost+propay+tcbpay}</u></th>
                                </tr>
                                <tr style="border-style: hidden">
                                    <th style="text-align: center;border-style: hidden"></th>
                                    <th style="text-align: center;border-style: hidden">Net Balance</th>
                                    <th style="text-align: center;border-style: hidden"><u>${(amount+tcpay+tdebit+prorecv)-(tcredit+tpay+tcost+empcost+propay+tcbpay)}</u></th>
                                    <th style="text-align: center;border-style: hidden"></th>
                                </tr>
                            </tbody>
                        </table>
