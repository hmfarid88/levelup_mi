...
try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                     ...
                     <table border="2" width="100%" style="background-color: #030303; color: #ffffff" class="table table-condensed table-responsive">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">${((totalsale-totalbuy)+totalcommi1+totalcommi2)-(totalcost+totalemp)}</td> 
                                <td style="text-align: center"></td> 
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">${((totalsale-totalbuy)+totalcommi1+totalcommi2)-(totalcost+totalemp+totalwith+totalsaleback)}</td> 
                                <td style="text-align: center"></td> 
                            </tr>
                        </table>
                </div>
