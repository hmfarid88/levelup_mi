    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
            ...
            try {
                ...
                String query = "select  RETAILER, AMOUNT, DUE from re_email_pay where SI_NO=?";
            ...
            message.setSubject("MI (Retailer Payment Report)");
            StringBuilder sb = new StringBuilder();
            sb.append("From MI Distribution House").append(System.lineSeparator());
            ...
            sb.append("MI DISTRIBUTION HOUSE");
            ...
            response.sendRedirect("pending_mail.jsp");
                ...
                rs1.next();
                String mailto = rs1.getString(1);
                  String reemail="insert into re_email_pay(RETAILER, AMOUNT, DUE, EMAIL, DATE) values (?,?,?,?, CURDATE())";
