...
//compose message
        try {
            ...
            message.setSubject("Data Backup From  MI");
                        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        Multipart multipart = new MimeMultipart();
       
        String file = "D:\\Level Up\\Backup File\\mi_dist.sql";
        
        String fileName = "mi_dist.sql";
        ...
        message.setContent(multipart);
            ...
            File f=new File("D:\\Level Up\\Backup File\\mi_dist.sql");
            f.delete();
